...
## 5. Roadmap
- **MVP (Weeks 1-3):** Core Task Management (List/Create/Delete/Complete), Search, Sort, Responsive Design, Basic A11y.
...
*For detailed constraints, refer to `.agent/rules/techstack.md` and `.agent/rules/architecture.md`.*
